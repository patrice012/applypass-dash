      ...
      {status == "authenticated" && (
        <div className="flex h-screen w-full  bg-muted/40">
          <div
                            ...
                            <div className="w-full flex flex-col md:flex-row gap-4  md:items-center py-4 px-[10px] md:p-4 rounded-xl bg-[#F6F5F4] border border-[#E5E7EB] justify-between">
                              ...
                              <div className="flex gap-[8px]">
                                <button
                                  ...
                                  className="bg-[#34D399] hover:bg-[#fff] hover:text-[#34D399] transition ease-in-out duration-500  w-full justify-center md:items-center flex gap-[8px] items-center rounded-full border border-[#059669]  px-[16px] md:w-[180px] py-[10px] text-[14px] font-medium  text-[#fff] text-nowrap">
                                  <User size={20} color="#FDE68A" /> Added to
                                  Queue
                                </button>
                            ...
                            <div className="flex gap-[8px]">
                              <Tooltip>
                                ...
                                <TooltipTrigger className="bg-[#FFFFFF] w-full justify-center md:items-center flex gap-[8px] items-center rounded-full md:w-[180px] border border-[#059669]  hover:bg-[#059669]/10 transition ease-in-out duration-500 px-[16px] py-[10px] text-[14px] font-medium  text-[#001E52] text-nowrap">
                                  <Plus size={20} color="#001E52" /> Available
                                  to Apply
                                </TooltipTrigger>
                              </Tooltip>
            ...
            {/* <div className="max-w-max m-auto my-4">
          <button className="border border-[#6805DA] text-[#6805DA] px-5 py-2 rounded-[100px]">
            Load More Jobs
          </button>
        </div> */}
          </div>
